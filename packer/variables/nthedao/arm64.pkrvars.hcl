...
# Pairs with: templates/nthedao/ubuntu2604-arm64-hardened.pkr.hcl
#
# Compliance: CIS-L1 (no FIPS).
# Use case: the personal k3s-etcd QEMU lab on Apple Silicon. Published to
# Vagrant Cloud as nthedao2705/ubuntu2604-cisl1-arm64 and consumed by
...
#
# Stage 1's ISO/checksum live in variables/_base/ubuntu2604-arm64-base.pkrvars.hcl;
...
# Matches the Vagrant Cloud box name nthedao2705/ubuntu2604-cisl1-arm64.
image_name_prefix = "nthedao-ubuntu2604-cisl1-arm64"
...
base_image_path = "output/base/ubuntu2604-arm64/latest/ubuntu2604-arm64-base-latest.qcow2"
